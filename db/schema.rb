...
ActiveRecord::Schema.define(version: 2019_01_11_221558) do
  ...
  create_table "event_group_relationships", force: :cascade do |t|
    t.integer "event_id"
    t.integer "group_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id"], name: "index_event_group_relationships_on_event_id"
    t.index ["group_id"], name: "index_event_group_relationships_on_group_id"
  end
